...
class EmailConfirmationPage
    extends BaseGetResponsiveView<EmailConfirmationController> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          AppString.txtEmailSuccessfullMessage,
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                              ...
                              onPressed: () {
                                controller.callGoToSignIn();
                              },
                              child: Text(
                                AppString.txtGotoSignIn,
                                style: TextStyle(
                                    color: Colors.white,
                                    fontFamily: 'josefinsans',
                                    fontSize: 18),
  ...
  @override
  String getTag() {
    return (EmailConfirmationController).toString();
  }
}